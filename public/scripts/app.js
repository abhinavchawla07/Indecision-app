...
var Options = function (_React$Component3) {
    ...
    _createClass(Options, [{
        ...
        value: function removeClick() {
            _set(Options.prototype.__proto__ || Object.getPrototypeOf(Options.prototype), "options", [], this);
            alert("removed all!");
        }
    }, {
        key: "render",
...
var AddOption = function (_React$Component5) {
    ...
    _createClass(AddOption, [{
        ...
        value: function handleAddOptions(e) {
            e.preventDefault();
            var option = e.target.elements.getElementByName("option").value;
            // if(option){
            // alert(option);
            // }
            alert(option);
